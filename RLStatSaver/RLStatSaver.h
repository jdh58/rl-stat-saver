...
class RLStatSaver: public BakkesMod::Plugin::BakkesModPlugin/*, public BakkesMod::Plugin::PluginSettingsWindow*//*, public BakkesMod::Plugin::PluginWindow*/
{
	...
	*/
	...
	std::string menuTitle_ = "RLStatSaver";
